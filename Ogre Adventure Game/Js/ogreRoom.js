...
// Fight Order: Armor, Weapon, Potion
...
function ogreRoom()
{
	...
	else
	{
		...
		description = "<p>You came unprepared and have died. Press 'F5' to refresh and start over. Bring armor, a weapon, and a potion next time.</p>"
	}
